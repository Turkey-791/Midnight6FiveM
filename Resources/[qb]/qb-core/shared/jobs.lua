...
QBCore.Shared.Jobs = {
	...
	-- バス運転手
	bus = { label = 'バス', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = '運転手', payment = 0 } } },
	-- 裁判官
	...
	-- 記者
	reporter = { label = '記者', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = 'ジャーナリスト', payment = 0 } } },
	-- トラッカー
	trucker = { label = 'トラック運転手', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = '運転手', payment = 0 } } },
	-- 牽引業
	tow = { label = '牽引', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = '運転手', payment = 0 } } },
	-- 清掃員
	garbage = { label = '清掃', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = '収集員', payment = 0 } } },
	-- ぶどう園
	vineyard = { label = 'ぶどう園', defaultDuty = true, offDutyPay = false, grades = { ['0'] = { name = '収穫者', payment = 0 } } },
	-- ホットドッグ販売員
	...
	taxi = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = '研修生', payment = 0 },
			['1'] = { name = '運転手', payment = 0 },
			['2'] = { name = 'イベントドライバー', payment = 0 },
			['3'] = { name = '営業担当', payment = 0 },
			['4'] = { name = 'マネージャー', isboss = true, payment = 0 },
		},
	},
	-- 車ディーラー
	cardealer = {
